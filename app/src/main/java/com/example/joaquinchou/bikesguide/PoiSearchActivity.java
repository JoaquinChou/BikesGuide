...
import com.example.joaquinchou.bikesguide.adapter.PoiItemAdapter;
import com.example.joaquinchou.bikesguide.adapter.TipAdapter;

import java.util.List;

public class PoiSearchActivity extends AppCompatActivity implements SearchView.OnQueryTextListener,
    ...
    public boolean onQueryTextChange(String newText) {
        if(newText!=null&&!newText.equals("")){
            ...
            Inputtips inputTips = new Inputtips(PoiSearchActivity.this.getApplicationContext(),
                    inputtipsQuery);
